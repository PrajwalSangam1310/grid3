...
class SmartController:
    ...
    def __init__(self, target_points = (), radial_gain_constant = 0.8, linear_gain_constant = 0.2, distance_threshold = 0.01, angle_threshold = 0.05):
    ...
    def calculate_command(self):
        ...
        if self.linear_velocity < self.SUB_DISTANCE_THRESHOLD:
